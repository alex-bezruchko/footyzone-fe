...
class SingleNews extends React.Component {
  ...
  render() {
    return (
      <div className="col-md-8 col-xs-12 news single">
        {this.props.loading ? (
                  ...
                  <div className="single-body">
                    <div className="body">
                      ...
                      <p>
                        ...
                        infrastructure" following Arsene Wenger's departure from
                        the club as manager last summer.
                      </p>
                      ...
                      <p>
                        ...
                        2019-20 Champions League, we respectfully disagree it is
                        at a crossroads and things need to change because so
                      ...
                      <p>
                        ...
                        traditional model of football operations that included a
                        Manager and CEO, to a new chapter of Arsenal Football
                        Club that is led by a Head of Football and Managing
                        Director.
                      </p>
                      <p>
                        Arsenal are not at a crossroads according to director
                        Josh Kroenke in a passionate response to an open letter
                        from fans criticising his father's running of the club.
                      </p>
